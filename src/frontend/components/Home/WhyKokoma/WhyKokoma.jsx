...
const WhyKokoma = () => {
    return (
        <div
            className='h-screen p-20 bg-cover bg-center'
            style={{ backgroundImage: `url(${bg.src})` }}
        >
            <div className='bg-white bg-opacity-50 p-10 rounded-3xl shadow-lg shadow-black h-full flex flex-col space-y-10'>
                <h1 className='font-[600] text-[#112D4E] text-[50px] leading-[100%] text-left'>
                    Why Kokoma
                </h1>
                <p className='font-[300] text-black text-[18px] text-left'>
